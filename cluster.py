...
class DensityPeakCluster(object):
    ...
    def cluster(self, distances, max_dis, min_dis, max_id, density_threshold, distance_threshold, dc=None, auto_select_dc=False):
        '''
        Cluster the data
        ...
        '''
        assert not (dc is not None and auto_select_dc)
        rho = self.local_density(distances, max_dis, min_dis, max_id, dc=dc, auto_select_dc=auto_select_dc)
        delta = min_distance(max_id, max_dis, distances, rho)
